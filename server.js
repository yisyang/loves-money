...
(function() {
  var AuthJwt, DynamicViewsHandler, allowDomain, app, bodyParser, browserify, config, cookieParser, eh, express, favicon, logger, lovesMoneyRedirector, middlewares, modelsLoader, multiViews, path, routesLoader, views, _;

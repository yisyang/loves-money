...
(function() {
  var DynamicViewsHandler, allowDomain, app, bodyParser, browserify, config, cookieParser, eh, express, favicon, logger, modelsLoader, multiViews, path, routesLoader, views, _;
  ...
  app.use('*.coffee', function(req, res) {
    ...
    return eh.displayError(res, err, req.app.get('config').env);
  });

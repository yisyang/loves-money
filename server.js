...
(function() {
  var CorsHandler, DynamicViewsHandler, ErrorHandler, MiddlewaresLoader, ModelsLoader, MultiViews, RoutesLoader, app, bodyParser, browserify, config, cookieParser, express, favicon, logger, path, staticRoute, staticRoutes, views, _, _i, _j, _len, _len1;

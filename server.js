...
(function() {
  var DynamicViewsHandler, allowDomain, app, bodyParser, browserify, config, cookieParser, eh, express, favicon, logger, middlewares, modelsLoader, multiViews, path, routesLoader, views, _;
